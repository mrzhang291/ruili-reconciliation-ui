...
test("keeps only effective enabled rules and builds a versioned snapshot", () => {
  const rows = [
    ["RULE-2", "店铺号规则", ["金额口径"], "仅 SHNKA2 使用", "SHNKA2, HZAD02", 120, "v2", ["启用"], "2026-08-20T00:00:00+08:00", "2026-08-21T10:00:00+08:00"],
  ...
  const instructions = buildKnowledgeInstructions(rules, "SHNKA2");
  assert.match(instructions, /RULE-2\/v2/);
  assert.match(instructions, /RULE-1\/v1/);
  assert.match(instructions, /仅 SHNKA2 使用/);
